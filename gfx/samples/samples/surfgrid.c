 ...
 *      l       toggle between pulling line polygon away from fill polygon and
 *                             pushing fill polygon away from line polygon 
 *	escape	quit
 */
#include <stdio.h>
#include <string.h>
...
void menu(int item)
{
	...
	if (isPullLineAwayFromFill) {
	   ...
	   printf("Try factor= -0.5, units= -1.0.\n");
	}
	else {
	  printf("Pull line polygon away from fill polygon off. ");
	  printf("Try factor= 0.5, units= 1.0. \n");
	}
        break;
    }
...
int main(int argc, char **argv)
{
    ...
    glutAddMenuEntry("l: toggle pull/push line/fill away from fill/line", 'l');
