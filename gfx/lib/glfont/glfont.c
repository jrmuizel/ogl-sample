...
*/
/*
** $Header: //depot/main/gfx/lib/glfont/glfont.c#4 $
*/
...
GLenum fontCreateStroke(GLuint fontBase)
{
	...
	for (j = 1; (mode = strokeFont[i][j]) != END_OF_LIST; j += 3) {
	    if (mode == FONT_BEGIN) {
...
GLenum fontCreateOutline(GLuint fontBase)
{
	...
	for (j = 1; (mode = outlineFont[i][j]) != END_OF_LIST; j += 3) {
	    if (mode == FONT_BEGIN) {
...
GLenum fontCreateFilled(GLuint fontBase)
{
	...
	for (j = 1; (mode = filledFont[i][j]) != END_OF_LIST; j += 3) {
	    if (mode == FONT_BEGIN) {
