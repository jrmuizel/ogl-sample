...
**
** $Date$ $Revision$
** $Header: //depot/main/gfx/lib/opengl/include/image.h#6 $
*/
...
extern void __glFillImage(__GLcontext *gc, GLsizei width, GLsizei height, 
			  GLenum format, GLenum type, const GLvoid *userdata, 
			  GLubyte *newimage);

extern void __glFillImage3D(__GLcontext *gc, GLsizei width, GLsizei height, 
